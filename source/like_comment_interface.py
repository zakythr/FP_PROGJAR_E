...
def click():
    global i
    global jumlahLike
    b = Button(master=mainframe, text="Like", width=10, command=like)
    ...
    f = Label(master=mainframe, text="%d Liked" % jumlahLike)
...
def like():
    ...
    jumlahLike += 1
    tambah = jumlahLike
    button = Button(mainframe, text="Liked", bg='green', width=10, command=unlike)
    button.grid(row=3, column=0)
    label = Label(mainframe, text="%d Liked" % tambah)
    label.grid(row=3, column=4, sticky=E, padx=5, pady=5)
...
def unlike():
    ...
    button.grid_remove()
    label.grid_remove()
    # Label(mainframe, text="%d Liked" % kurang).grid(row=3, column=4, sticky=E, padx=5, pady=5)
i = 4
jumlahLike = 25
